...
//!
//! ```js
//! import { Dataset, ChiSquared, PearsonCorrelation, FisherZ } from "../pkg/citest_js.js";
//!
...
ci_test_class!(
    ...
    &["yates"],
    citest::ci_tests::ChiSquared { yates: cfg.yates }
);
...
ci_test_class!(
    ...
    "DiscreteOptions | undefined",
    &["yates"],
    citest::ci_tests::LogLikelihood { yates: cfg.yates }
);
...
ci_test_class!(
    ...
    "DiscreteOptions | undefined",
    &["yates"],
    citest::ci_tests::CressieRead { yates: cfg.yates }
);
...
ci_test_class!(
    ...
    "DiscreteOptions | undefined",
    &["yates"],
    citest::ci_tests::FreemanTukey { yates: cfg.yates }
);
...
ci_test_class!(
    ...
    "DiscreteOptions | undefined",
    &["yates"],
    citest::ci_tests::ModifiedLikelihood { yates: cfg.yates }
);
