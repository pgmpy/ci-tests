...
// (`crates/citest/tests/golden.rs`) and Python
// (`crates/citest-python/test/test_golden.py`) gates.
...
// The wasm package is generated by `wasm-pack build crates/citest-js --target nodejs`
// into `crates/citest-js/pkg`. It is a CommonJS module; default-import then
...
// crates/citest-js/tests/golden.test.js -> repo root is three parents up.
