# Type stubs for the native `ci_python._ci_python` extension module.
# Hand-maintained to match `crates/ci-python/src/lib.rs`.
...
class ChiSquared(_BaseTest):
    def __init__(self, data: Dataset | dict[str, ColumnSpec], yates: bool = ...) -> None: ...
...
class PearsonCorrelation(_BaseTest):
    def __init__(self, data: Dataset | dict[str, ColumnSpec]) -> None: ...

class PearsonEquivalence(_BaseTest):
    def __init__(
        self,
        data: Dataset | dict[str, ColumnSpec],
